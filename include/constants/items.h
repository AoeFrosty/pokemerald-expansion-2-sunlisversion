...
// TMs/HMs
#define ITEM_TM_FOCUS_PUNCH 582
#define ITEM_TM_DRAGON_CLAW 583
#define ITEM_TM_WATER_PULSE 584
#define ITEM_TM_CALM_MIND 585
#define ITEM_TM_ROAR 586
#define ITEM_TM_TOXIC 587
#define ITEM_TM_SNOWSCAPE 588
#define ITEM_TM_BULK_UP 589
#define ITEM_TM_BULLET_SEED 590
#define ITEM_TM_HIDDEN_POWER 591
#define ITEM_TM_SUNNY_DAY 592
#define ITEM_TM_TAUNT 593
#define ITEM_TM_ICE_BEAM 594
#define ITEM_TM_BLIZZARD 595
#define ITEM_TM_HYPER_BEAM 596
#define ITEM_TM_LIGHT_SCREEN 597
#define ITEM_TM_PROTECT 598
#define ITEM_TM_RAIN_DANCE 599
#define ITEM_TM_GIGA_DRAIN 600
#define ITEM_TM_SAFEGUARD 601
#define ITEM_TM_WAVE_CRASH 602
#define ITEM_TM_SOLAR_BEAM 603
#define ITEM_TM_IRON_TAIL 604
#define ITEM_TM_THUNDERBOLT 605
#define ITEM_TM_THUNDER 606
#define ITEM_TM_EARTHQUAKE 607
#define ITEM_TM_ROOST 608
#define ITEM_TM_DIG 609
#define ITEM_TM_PSYCHIC 610
#define ITEM_TM_SHADOW_BALL 611
#define ITEM_TM_BRICK_BREAK 612
#define ITEM_TM_FOCUS_BLAST 613
#define ITEM_TM_REFLECT 614
#define ITEM_TM_SHOCK_WAVE 615
#define ITEM_TM_FLAMETHROWER 616
#define ITEM_TM_SLUDGE_BOMB 617
#define ITEM_TM_SANDSTORM 618
#define ITEM_TM_FIRE_BLAST 619
#define ITEM_TM_ROCK_TOMB 620
#define ITEM_TM_AERIAL_ACE 621
#define ITEM_TM_TORMENT 622
#define ITEM_TM_FACADE 623
#define ITEM_TM_ENERGY_BALL 624
#define ITEM_TM_REST 625
#define ITEM_TM_ATTRACT 626
#define ITEM_TM_THIEF 627
#define ITEM_TM_STEEL_WING 628
#define ITEM_TM_SKILL_SWAP 629
#define ITEM_TM_SNATCH 630
#define ITEM_TM_OVERHEAT 631
#define ITEM_TM_CHARGE_BEAM 632
#define ITEM_TM_ENDURE 633
#define ITEM_TM_DRAGON_PULSE 634
#define ITEM_TM_DRAIN_PUNCH 635
#define ITEM_TM_WILL_O_WISP 636
#define ITEM_TM_EXPLOSION 637
#define ITEM_TM_SHADOW_CLAW 638
#define ITEM_TM_PAYBACK 639
#define ITEM_TM_GIGA_IMPACT 640
#define ITEM_TM_ROCK_POLISH 641
#define ITEM_TM_STONE_EDGE 642
#define ITEM_TM_AVALANCHE 643
#define ITEM_TM_THUNDER_WAVE 644
#define ITEM_TM_GYRO_BALL 645
#define ITEM_TM_SWORDS_DANCE 646
#define ITEM_TM_STEALTH_ROCK 647
#define ITEM_TM_PSYCH_UP 648
#define ITEM_TM_DARK_PULSE 649
#define ITEM_TM_ROCK_SLIDE 650
#define ITEM_TM_X_SCISSOR 651
#define ITEM_TM_SLEEP_TALK 652
#define ITEM_TM_POISON_JAB 653
#define ITEM_TM_GRASS_KNOT 654
#define ITEM_TM_SWAGGER 655
#define ITEM_TM_PLUCK 656
#define ITEM_TM_U_TURN 657
#define ITEM_TM_DOUBLE_IRON_BASH 658
#define ITEM_TM_FLASH_CANNON 659
#define ITEM_TM_TRICK_ROOM 660
#define ITEM_TM_HONE_CLAWS 661
#define ITEM_TM_PSYSHOCK 662
#define ITEM_TM_VENOSHOCK 663
#define ITEM_TM_SMACK_DOWN 664
#define ITEM_TM_SLUDGE_WAVE 665
#define ITEM_TM_FLAME_CHARGE 666
#define ITEM_TM_LOW_SWEEP 667
#define ITEM_TM_ECHOED_VOICE 668
#define ITEM_TM_ACCELEROCK 669
#define ITEM_TM_AEROBLAST 670
#define ITEM_TM_AROMATIC_MIST 671
#define ITEM_TM_BOOMBURST 672
#define ITEM_TM_BOUNCY_BUBBLE 673
#define ITEM_TM_DIAMOND_STORM 674
#define ITEM_TM_ALLY_SWITCH 675
#define ITEM_TM_SCALD 676
#define ITEM_TM_FIRE_LASH 677
#define ITEM_TM_QUASH 678
#define ITEM_TM_ACROBATICS 679
#define ITEM_TM_RETALIATE 680
#define ITEM_TM_VOLT_SWITCH 681
...
#define ITEM_TROPIUSITE 869
#define ITEM_RAICHUNITE_X 870
#define ITEM_RAICHUNITE_Y 871
#define ITEM_CLEFABLITE_X 872
#define ITEM_VICTREEBELITE 873
#define ITEM_STARMINITE 874
#define ITEM_DRAGONINITE 875
#define ITEM_MEGANIUMITE 876
#define ITEM_FERALIGITE 877
#define ITEM_SKARMORITE 878
#define ITEM_CHIMECHITE 879
#define ITEM_ABSOLITE_Z 880
#define ITEM_STARAPTITE 881
#define ITEM_GARCHOMPITE_Z 882
#define ITEM_LUCARIONITE_Z 883
#define ITEM_FROSLASSITE 884
#define ITEM_HEATRANITE 885
#define ITEM_DARKRANITE 886
#define ITEM_EMBOARITE 887
#define ITEM_EXCADRITE 888
#define ITEM_SCOLIPITE 889
#define ITEM_SCRAFTINITE_X 890
#define ITEM_EELEKTROSSITE 891
#define ITEM_CHANDELURITE 892
#define ITEM_GOLURKITE 893
#define ITEM_CHESNAUGHTITE 894
#define ITEM_DELPHOXITE 895
#define ITEM_GRENINJITE 896
#define ITEM_PYROARITE 897
#define ITEM_FLOETITE 898
#define ITEM_MEOWSTICITE 899
#define ITEM_MALAMARITE 900
#define ITEM_BARBARACITE_X 901
#define ITEM_DRAGALGITE 902
#define ITEM_HAWLUCHANITE 903
#define ITEM_ZYGARDITE 904
#define ITEM_CRABOMINITE 905
#define ITEM_GOLISOPITE 906
#define ITEM_DRAMPANITE 907
#define ITEM_MAGEARNITE 908
#define ITEM_ZERAORITE 909
#define ITEM_FALINKSITE_X 910
#define ITEM_SCOVILLAINITE 911
#define ITEM_GLIMMORANITE 912
#define ITEM_TATSUGIRINITE 913
#define ITEM_BAXCALIBRITE 914
#define ITEM_LIEPARDITE 915
#define ITEM_CLEFABLITE_Y 916
#define ITEM_TOGEKISSITE 917
#define ITEM_DEWGONITE 918
#define ITEM_ARCANINITE_H 919
#define ITEM_MISMAGITE 920
#define ITEM_SCRAFTINITE_Y 921
#define ITEM_NOCTOWLITE 922
#define ITEM_LEDIANITE 923
#define ITEM_FALINKSITE_Y 924
#define ITEM_BARBARACITE_Y 925
#define ITEM_CORSOLITE 926
#define ITEM_BEARTITE 927
#define ITEM_HYPNITE 928
#define ITEM_SUNFLORITE 929
#define ITEM_SILVER_ORB 930
#define ITEM_RAINBOW_ORB 931
#define ITEM_FLOETTITE 932

//Balls
// #define ITEM_DIGI_BALL 933
// #define ITEM_RESET_BALL 934
#define ITEM_CYRO_BALL 935

//Berries
// #define ITEM_GLOWBERRY 936       //makes shiny
#define ITEM_SUB_BERRY 937        //at 25% hp make substitute
...
#define ITEM_SNIPER_GOGGLES 942
// #define ITEM_GLUE_TRAP 943       //holder cannot switch out
// #define ITEM_RESET_BUTTON 944
#define ITEM_SAND_BAG 945
#define ITEM_HARD_HAT 946
#define ITEM_LOVERS_GIFT 947
#define ITEM_FROST_ORB 948
#define ITEM_IRON_MASK 949
#define ITEM_FESTIVE_COAT 950  //buff delibird
#define ITEM_MUSIC_BOX 951      //buff chatot and sqwakabilly
...
#define ITEM_TM_FROST_BREATH 957
#define ITEM_TM_DRAGON_TAIL 958
#define ITEM_TM_VOLT_TACKLE 959
#define ITEM_TM_WILD_CHARGE 960
#define ITEM_TM_SNARL 961
#define ITEM_TM_INFESTATION 962
#define ITEM_TM_MOONBLAST 963
#define ITEM_TM_CONFIDE 964
#define ITEM_TM_LEECH_LIFE 965
#define ITEM_TM_BRUTAL_SWING 966
#define ITEM_TM_SMART_STRIKE 967
#define ITEM_TM_AURORA_VEIL 968
#define ITEM_TM_FIRE_PUNCH 969
#define ITEM_TM_ICE_PUNCH 970
#define ITEM_TM_THUNDER_PUNCH 971
#define ITEM_TM_PIN_MISSILE 972
#define ITEM_TM_MAGICAL_LEAF 973
#define ITEM_TM_SOLAR_BLADE 974
#define ITEM_TM_FIRE_SPIN 975
#define ITEM_TM_SCREECH 976
#define ITEM_TM_SNORE 977
#define ITEM_TM_SCARY_FACE 978
#define ITEM_TM_ICY_WIND 979
#define ITEM_TM_CHARM 980
#define ITEM_TM_WHIRLPOOL 981
#define ITEM_TM_SWIFT 982
#define ITEM_TM_HELPING_HAND 983
#define ITEM_TM_REVENGE 984
#define ITEM_TM_IMPRISON 985
#define ITEM_TM_WEATHER_BALL 986
#define ITEM_TM_FAKE_TEARS 987
#define ITEM_TM_SAND_TOMB 988
#define ITEM_TM_ICICLE_SPEAR 989
#define ITEM_TM_BOUNCE 990
#define ITEM_TM_MUD_SHOT 991
#define ITEM_TM_ROCK_BLAST 992
#define ITEM_TM_EXPANDING_FORCE 993
#define ITEM_TM_SKITTER_SMACK 994
#define ITEM_TM_METEOR_BEAM 995
#define ITEM_TM_METAL_SOUND 996
#define ITEM_TM_CURSE 997
#define ITEM_TM_THUNDER_FANG 998
#define ITEM_TM_ICE_FANG 999
#define ITEM_TM_FIRE_FANG 1000
#define ITEM_TM_PSYCHO_CUT 1001
#define ITEM_TM_WONDER_ROOM 1002
#define ITEM_TM_MAGIC_ROOM 1003
#define ITEM_TM_CROSS_POISON 1004
#define ITEM_TM_HEX 1005
#define ITEM_TM_ELECTROWEB 1006
#define ITEM_TM_DRAGON_ENERGY 1007
#define ITEM_TM_PHANTOM_FORCE 1008
#define ITEM_TM_DRAINING_KISS 1009
#define ITEM_TM_MYSTICAL_FIRE 1010
#define ITEM_TM_EERIE_IMPULSE 1011
#define ITEM_TM_AIR_SLASH 1012
#define ITEM_TM_STOMPING_TANTRUM 1013
#define ITEM_TM_BREAKING_SWIPE 1014
#define ITEM_TM_BODY_SLAM 1015
#define ITEM_TM_HYDRO_PUMP 1016
#define ITEM_TM_LOW_KICK 1017
#define ITEM_TM_AGILITY 1018
#define ITEM_TM_METRONOME 1019
#define ITEM_TM_AMNESIA 1020
#define ITEM_TM_TRI_ATTACK 1021
#define ITEM_TM_SPIKES 1022
#define ITEM_TM_OUTRAGE 1023
#define ITEM_TM_MEGAHORN 1024
#define ITEM_TM_BATON_PASS 1025
#define ITEM_TM_ENCORE 1026
#define ITEM_TM_CRUNCH 1027
#define ITEM_TM_UPROAR 1028
#define ITEM_TM_HEAT_WAVE 1029
#define ITEM_TM_TRICK 1030
#define ITEM_TM_HYPER_VOICE 1031
#define ITEM_TM_MUDDY_WATER 1032
#define ITEM_TM_IRON_DEFENSE 1033
#define ITEM_TM_LEAF_BLADE 1034
#define ITEM_TM_DRAGON_DANCE 1035
#define ITEM_TM_CLOSE_COMBAT 1036
#define ITEM_TM_TOXIC_SPIKES 1037
#define ITEM_TM_FLARE_BLITZ 1038
#define ITEM_TM_TRIPLE_AXEL 1039
#define ITEM_TM_COACHING 1040
#define ITEM_TM_SCORCHING_SANDS 1041
#define ITEM_TM_FLOATY_FALL 1042
#define ITEM_TM_BUG_BUZZ 1043
#define ITEM_TM_POWER_GEM 1044
#define ITEM_TM_BRAVE_BIRD 1045
#define ITEM_TM_EARTH_POWER 1046
#define ITEM_TM_NASTY_PLOT 1047
#define ITEM_TM_ZEN_HEADBUTT 1048
#define ITEM_TM_LEAF_STORM 1049
#define ITEM_TM_GUNK_SHOT 1050
#define ITEM_TM_IRON_HEAD 1051
#define ITEM_TM_HEAVY_SLAM 1052
#define ITEM_TM_FOUL_PLAY 1053
#define ITEM_TM_STORED_POWER 1054
#define ITEM_TM_DRILL_RUN 1055
#define ITEM_TM_ROCK_WRECKER 1056
#define ITEM_TM_HURRICANE 1057
#define ITEM_TM_PLAY_ROUGH 1058
#define ITEM_TM_ICICLE_CRASH 1059
#define ITEM_TM_DARKEST_LARIAT 1060
#define ITEM_TM_HIGH_HORSEPOWER 1061
#define ITEM_TM_THROAT_CHOP 1062
#define ITEM_TM_POLLEN_PUFF 1063
#define ITEM_TM_PSYCHIC_FANGS 1064
#define ITEM_TM_LIQUIDATION 1065
#define ITEM_TM_BODY_PRESS 1066
#define ITEM_TM_SIGNAL_BEAM 1067
#define ITEM_TM_TRAILBLAZE 1068
#define ITEM_TM_POUNCE 1069
#define ITEM_TM_METAL_CLAW 1070
#define ITEM_TM_FLEUR_CANNON 1071
#define ITEM_TM_TAILWIND 1072
#define ITEM_TM_ICE_SPINNER 1073
#define ITEM_TM_BLAST_BURN 1074
#define ITEM_TM_HYDRO_CANNON 1075
#define ITEM_TM_FRENZY_PLANT 1076
#define ITEM_TM_DRACO_METEOR 1077
#define ITEM_TM_STEEL_BEAM 1078
#define ITEM_TM_HAZE 1079
#define ITEM_TM_GRAVITY 1080
#define ITEM_TM_CHILLY_RECEPTION 1081
#define ITEM_TM_TIDY_UP 1082
#define ITEM_TM_LUNGE 1083
#define ITEM_TM_HEADLONG_RUSH 1084
#define ITEM_TM_BURNING_JEALOUSY 1085
#define ITEM_TM_FLIP_TURN 1086
#define ITEM_TM_DUAL_WINGBEAT 1087
#define ITEM_TM_SCALE_SHOT 1088
#define ITEM_TM_DOUBLE_EDGE 1089
#define ITEM_TM_PETAL_BLIZZARD 1090
#define ITEM_TM_EXO_BASH 1091
#define ITEM_TM_ADRENALINE 1092
#define ITEM_TM_BANSHEE_SCREAM 1093
#define ITEM_TM_MYTHIC_BLOW 1094
#define ITEM_TM_SPARKLE_STRIKE 1095
#define ITEM_TM_DARK_SURGE 1096
#define ITEM_TM_FINAL_MIGHT 1097
#define ITEM_TM_TALON_STRIKE 1098
#define ITEM_TM_LOCUST_SWARM 1099
#define ITEM_TM_THUNDER_SPEAR 1100
#define ITEM_TM_CYCLONE 1101
#define ITEM_TM_FRIGID_PUNCH 1102
#define ITEM_TM_VENOM_REND 1103
#define ITEM_TM_TRIPLE_WHIP 1104
