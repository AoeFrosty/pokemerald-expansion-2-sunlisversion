...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_FRENZY_PLANT] =
    {
        ...
        .description = COMPOUND_STRING(
            "A two turn leaf storm that\n"
            "raises Sp.A, 1 turn in sun."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_ROAR_OF_TIME] =
    {
        ...
        .description = COMPOUND_STRING(
            "Powerful blast of draconic\n"
            "fury. Lower's own speed."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
        .accuracy = 90,
    ...
    [MOVE_TOXIC_THREAD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "poisons and drops Speed heavily."),
    ...
    [MOVE_STEEL_ROLLER] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .argument = ARG_TRY_REMOVE_TERRAIN_HIT, // Remove a field terrain if there is one.
        .skyBattleBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
    ...
    [MOVE_WICKED_BLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 60 : 80, //75 : 80
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_TRI_STRIKE] =
    {
        .name = COMPOUND_STRING("Tri Strike"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAZE_O_FURY] =
    {
        .name = COMPOUND_STRING("Blaze of Fury"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLACIAL_TEMPEST] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = TWO_TURN_ARG(STRINGID_ELECTROSHOTCHARGING, B_WEATHER_SNOW),
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_ATK_PLUS_1,
            .self = TRUE,
            .onChargeTurnOnly = TRUE,
    ...
    [MOVE_DESERT_STORM] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument = TWO_TURN_ARG(STRINGID_ELECTROSHOTCHARGING, B_WEATHER_SANDSTORM),
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_DEF_PLUS_1,
            .self = TRUE,
            .onChargeTurnOnly = TRUE,
    ...
    [MOVE_MOLTEN_BURST] =
    {
        .name = COMPOUND_STRING("Molten Burst"),
        .description = COMPOUND_STRING(
            "Crashes down on the\n"
    ...
    [MOVE_FURY_SWEEP] =
    {
        .name = COMPOUND_STRING("Fury Sweep"),
        .description = sStormThrowDescription,
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_FLYING,
    ...
    [MOVE_TECTONIC_SLAM] =
    {
        .name = COMPOUND_STRING("Tectonic Slam"),
        .description = COMPOUND_STRING(
            "Destroys barriers such as\n"
            "REFLECT and causes damage."),
        .effect = EFFECT_BRICK_BREAK,
    ...
    [MOVE_FOXFIRE] =
    {
        .name = COMPOUND_STRING("Foxfire"),
        .description = COMPOUND_STRING(
            "A mystical fire attack that\n"
            "may inflict a burn or confuse."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_IRON_FANG] =
    {
        .name = COMPOUND_STRING("Iron Fang"),
        .description = COMPOUND_STRING(
            "May cause flinching or\n"
            "lower the DEF of the foe."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_STEEL,
        .accuracy = 95,
    ...
    [MOVE_PAINT_BOMB] =
    {
        .name = COMPOUND_STRING("Paint Bomb"),
        .description = COMPOUND_STRING(
            "Fires a colorful paint\n"
            "bomb, making beautiful art."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_PAINT_BOMB,
            .chance = 30,
        }),
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
