...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_TOUGH_CLAWS, ABILITY_DRAGONATE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 95 : 75)   //+10
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SUN_MAGE, ABILITY_SOLAR_POWER, ABILITY_SPICY_SPRAY },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_FLASH_FIRE, ABILITY_PRIDE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_CHILL_OUT, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_GRAY,
