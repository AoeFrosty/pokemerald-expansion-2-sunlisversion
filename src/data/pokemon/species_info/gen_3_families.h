...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_QUICK_STRIKE, ABILITY_WIND_RIDER, ABILITY_PICKPOCKET },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_PICKPOCKET },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SWALOT] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SOUL_DRAIN, ABILITY_STICKY_HOLD, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_LIMBER, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SHARPEDO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_QUICK_STRIKE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_COMPETITIVE, ABILITY_DRAGON_SONG },
    #else
...
[SPECIES_FROSLASS_MEGA] =
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_ROCK_HEAD, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_GRAY,
