...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_SERENE_GRACE, ABILITY_PRIDE },
        .bodyColor = BODY_COLOR_RED,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROYAL_COAT, ABILITY_UNNERVE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROYAL_COAT, ABILITY_PRIDE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_MEOWSTIC_M_MEGA] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "The defensive instinct of this\n"
            "mega is strong. It's when they're\n"
            "protecting themselves or their partners\n"
            "that they unleash their full power."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_BARBARACLE_MEGA_X] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_BarbaracleMegaX,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Barbaracle,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_BarbaracleMegaX,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = gMonPalette_BarbaracleMegaX,
        .shinyPalette = gMonShinyPalette_BarbaracleMegaX,
        .iconSprite = gMonIcon_BarbaracleMegaX,
        .iconPalIndex = 2,
        SHADOW(4, 14, SHADOW_SIZE_L)
        FOOTPRINT(Barbaracle)
        OVERWORLD(
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_CHILL_OUT, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
